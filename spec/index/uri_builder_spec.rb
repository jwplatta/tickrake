...
RSpec.describe Tickrake::Index::UriBuilder do
  describe ".build" do
    it "returns remote_uri for archived artifacts even when local copy is retained (storage_location=local)" do
    ...
    it "falls back to file:// when remote_uri is nil" do
      uri = described_class.build(
